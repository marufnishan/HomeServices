...
<head>
    <meta charset="utf-8">
    <title>NishanBD - Online Service Provider for your House Needs</title>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <ul class="visible-md visible-lg text-left">
                            <li><a href="tel:+911234567890"><i class="fa fa-phone"></i> 01718863771</a></li>
                            <li><a href="mailto:mdmarufnishan@gmail.com"><i class="fa fa-envelope"></i>
                                    mdmarufnishan@gmail.com</a></li>
                        </ul>
                        <ul class="visible-xs visible-sm">
                            ...
                            <li class="text-right"><a href="index.php/changelocation.html"><i
                                        class="fa fa-map-marker"></i> Ashulia, Dhaka</a></li>
                        </ul>
                    </div>
                    <div class="col-md-6">
                        <ul class="visible-md visible-lg text-right">
                            <li><i class="fa fa-comment"></i> Live Chat</li>
                            <li><a href="index.php/changelocation.html"><i class="fa fa-map-marker"></i> Ashulia, Dhaka</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="row visible-md visible-lg">
                    ...
                    <div class="col-md-3 col-xs-6 col-sm-6">
                        ...
                        <ul class="contact_footer">
                            <li class="location">
                                <i class="fa fa-map-marker"></i> <a href="#">Ashulia – Saver Dhaka, Bangladesh, Daffodil International University</a>
                            </li>
                            <li>
                                <i class="fa fa-envelope"></i> <a
                                    href="mailto:mdmarufnishan@gmail.com">mdmarufnishan@gmail.com</a>
                            </li>
                            <li>
                                <i class="fa fa-headphones"></i> <a href="tel:+911234567890">01718863771</a>
                            </li>
                        </ul>
                ...
                <div class="row visible-sm visible-xs">
                    <div class="col-md-6">
                        ...
                        <ul class="contact_footer mlist">
                            ...
                            <li>
                                <i class="fa fa-phone"></i> <a href="tel:+911234567890">01718863771</a>
                            </li>
                        </ul>
            ...
            <div class="footer-down">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <p class="text-xs-center crtext">&copy; Copyright © 2021 Maruf Nishan. All rights reserved.</p>
                        </div>
                    </div>
                </div>                
            </div>            
