...
class AdminEditServiceComponent extends Component
{
    ...
    public function updateService()
    {
        ...
        if($this->newthumbnail)
        {
            ...
            $imagName = Carbon::now()->timestamp. '.' . $this->newthumbnail->extension();
            $this->newthumbnail->storeAs('services/thumbnails',$imagName);
            $service->thumbnail = $imagName;
        }
        
        if($this->newimage)
        {
            unlink('images/services'.'/'.$service->image);
            $imagName2 = Carbon::now()->timestamp. '.' . $this->newimage->extension();
            $this->newimage->storeAs('services',$imagName2);
            $service->image = $imagName2;
        }
